!(function(t) {
  ...
  function(t, n, e) {
    ...
    function R(t, n, e, r, o, i) {
      for (var u, a = 0, c = n.length, s = i.length; a < s; ++a)
        (u = n[a])
          ? ((u.__data__ = i[a]), (r[a] = u))
          : (e[a] = new C(t, i[a]));
      for (; a < c; ++a) (u = n[a]) && (o[a] = u);
    }
    function d(t, n, e, r, o, i, u) {
      ...
      for (a = 0; a < l; ++a)
        (c = n[a]) &&
          ((R[a] = s = p + u.call(c, c.__data__, a, n)),
          s in f ? (o[a] = c) : (f[s] = c));
      for (a = 0; a < h; ++a)
        (c = f[(s = p + u.call(t, i[a], a, i))])
          ? ((r[a] = c), (c.__data__ = i[a]), (f[s] = null))
          : (e[a] = new C(t, i[a]));
      for (a = 0; a < l; ++a) (c = n[a]) && f[R[a]] === c && (o[a] = c);
    }
    function E(t, n) {
    ...
    function ot(t, n, e) {
      var r = $.hasOwnProperty(t.type) ? tt : nt;
    ...
    ct.prototype = st.prototype = {
      ...
      select: function(t) {
        ...
        for (
          ...
          for (
            var i, u, a = n[o], s = a.length, f = (r[o] = new Array(s)), l = 0;
            l < s;
            ++l
          )
            (i = a[l]) &&
      ...
      selectAll: function(t) {
        ...
        for (
          ...
          for (var u, a = n[i], c = a.length, s = 0; s < c; ++s)
            (u = a[s]) && (r.push(t.call(u, u.__data__, s, a)), o.push(u));
        return new ct(r, o);
      },
      filter: function(t) {
        ...
        for (
          ...
          for (
            var i, u = n[o], a = u.length, c = (r[o] = []), s = 0;
            s < a;
            ++s
          )
            (i = u[s]) && t.call(i, i.__data__, s, u) && c.push(i);
        return new ct(r, this._parents);
      },
      data: function(t, n) {
        if (!t)
        ...
        for (
          ...
          var l = o[f],
            ...
            _ = (c[f] = new Array(E)),
            N = (a[f] = new Array(E));
          r(l, h, _, N, (s[f] = new Array(C)), p, n);
          for (var m, y, v = 0, g = 0; v < E; ++v)
            if ((m = _[v])) {
              for (v >= g && (g = v + 1); !(y = N[g]) && ++g < E; );
              m._next = y || null;
            }
        }
        return ((a = new ct(a, o))._enter = c), (a._exit = s), a;
      },
      enter: function() {
      ...
      sort: function(t) {
        ...
        for (
          ...
          for (
            var u, a = e[i], c = a.length, s = (o[i] = new Array(c)), f = 0;
            f < c;
            ++f
          )
            (u = a[f]) && (s[f] = u);
      ...
      html: function(t) {
        return arguments.length
          ? this.each(null == t ? V : ('function' == typeof t ? Z : G)(t))
          : this.node().innerHTML;
      },
      raise: function() {
        return this.each(q);
      ...
      insert: function(t, n) {
        var e = 'function' == typeof t ? t : u(t),
          r = null == n ? W : 'function' == typeof n ? n : c(n);
        return this.select(function() {
...
*/
      ...
      p = function(t) {
        ...
        return void 0 === n
          ...
          : n.reduce(function(t, n) {
              var e = n.supportedActions.map(C),
                r = {type: C(n.value.type), data: n.value.data};
    ...
    var d = function(t) {
        ...
        function r(t, n) {
          ...
          function R() {
            ...
            if (t.charCodeAt(o) === s) {
              for (
                ;
                (u++ < i && t.charCodeAt(u) !== s) || t.charCodeAt(++u) === s;
          ...
          for (
            ...
            for (var d = []; r !== a && r !== c; ) d.push(r), (r = R());
            (n && null == (d = n(d, h++))) || o.push(d);
          }
          return o;
        }
        function o(n, e) {
        ...
        return {
          ...
          formatBody: function(t, n) {
            return null == n && (n = C(t)), o(t, n).join('\n');
          },
  ...
  function(t, n, e) {
    ...
    (function(n) {
      ...
      function l(t) {
        ...
        else if ('string' === u) for (e in ((o = new C(t, {})), f)) delete o[e];
        else if ('object' === u) {
      ...
      function C(t, n, e) {
        if (((t = c(t)), !(this instanceof C))) return new C(t, n, e);
        var i,
          u,
          a,
          f,
  ...
  function(t, n, e) {
    ...
    var r = e(5),
      o = e(3);
    e(19);
    const i = Object.assign({}, e(10), e(1)),
      u = 'localhost';
    function a(t) {
      const n = (function() {
          const t = i.select('body').attr('id', 'body');
          return (
            i
              .select('body')
              .selectAll('svg')
        ...
        e = o.a.getMaxDimensions('body'),
        r = t.tables.DEFAULT;
      if (r) {
        const o = {top: 10, bottom: 10, right: 10, left: 10},
          i = e.w - o.left - o.right,
          u = n
            .append('svg')
            .attr('height', 150)
            .attr('width', i)
        ...
        u
          ...
          .text(`dataset contains ${r.length} records`)
          .attr('height', 40)
          .attr('width', 250)
          .attr('x', i / 2)
          .attr('y', 30),
            ...
            .on('click', n => {
              !(function(t, n, e) {
                var r = document.createElement('a'),
                  o = new Blob([t], {type: e});
                (r.href = URL.createObjectURL(o)), (r.download = n), r.click();
              })(JSON.stringify(t), 'json.txt', 'text/plain');
            });
      }
    }
    function c(t) {
    ...
    !(async function() {
      window.location.hostname == u
        ? c(await i.json('./data/DS-data.json'))
        : r.subscribeToData(c, {transform: r.objectTransform});
    })();
  },
  function(t, n, e) {},
]);
